...
exports.AvmPlusValue = exports.XmlDocumentValue = exports.MovieClipValue = exports.RecordSetValue = exports.UnsupportedValue = exports.LongStringValue = exports.DateValue = exports.StrictArrayValue = exports.ObjectEndValue = exports.EcmaArrayValue = exports.ReferenceValue = exports.UndefinedValue = exports.NullValue = exports.TypedObjectValue = exports.ObjectValue = exports.ComplexValue = exports.StringValue = exports.BooleanValue = exports.NumberValue = exports.ObjectPropertyArraySerializer = exports.ObjectProperty = exports.Value = exports.TypeMarker = void 0;
...
exports.Value = Value;
class ObjectProperty extends bitstream_1.BitstreamElement {
...
__decorate([
    (0, bitstream_1.Field)(8 * 2, { writtenValue: (i) => Buffer.from(i.key).length }),
    __metadata("design:type", Number)
], ObjectProperty.prototype, "keyLength", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i.keyLength, { string: { encoding: 'utf-8' } }),
...
class ObjectPropertyArraySerializer {
...
exports.ObjectPropertyArraySerializer = ObjectPropertyArraySerializer;
...
NumberValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.Number)
], NumberValue);
...
BooleanValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.Boolean)
], BooleanValue);
...
__decorate([
    (0, bitstream_1.Field)(8 * 2, { writtenValue: (i) => Buffer.from(i.value).length }),
    __metadata("design:type", Number)
], StringValue.prototype, "length", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i.length, { string: { encoding: 'utf-8' } }),
    __metadata("design:type", String)
], StringValue.prototype, "$value", void 0);
StringValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.String)
], StringValue);
...
ComplexValue = __decorate([
    (0, bitstream_1.Variant)(i => [TypeMarker.Object, TypeMarker.TypedObject, TypeMarker.StrictArray, TypeMarker.EcmaArray].includes(i.marker))
], ComplexValue);
...
ObjectValue = __decorate([
    (0, bitstream_1.Variant)(i => [TypeMarker.Object, TypeMarker.TypedObject].includes(i.marker))
], ObjectValue);
...
__decorate([
    (0, bitstream_1.Field)(8 * 2, { writtenValue: (i) => Buffer.from(i.className).length }),
    __metadata("design:type", Number)
], TypedObjectValue.prototype, "classNameLength", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i.classNameLength, { string: { encoding: 'utf-8' } }),
    __metadata("design:type", String),
    __metadata("design:paramtypes", [Object])
], TypedObjectValue.prototype, "className", null);
TypedObjectValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.TypedObject)
], TypedObjectValue);
exports.TypedObjectValue = TypedObjectValue;
...
__decorate([
    (0, bitstream_1.Field)(8 * 2),
    __metadata("design:type", Number)
], ReferenceValue.prototype, "index", void 0);
ReferenceValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.Reference)
], ReferenceValue);
...
__decorate([
    (0, bitstream_1.Field)(8 * 4, { writtenValue: (i) => i._properties.length }),
    __metadata("design:type", Number)
], EcmaArrayValue.prototype, "_count", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i._count, { array: { type: ObjectProperty } }),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Object])
], EcmaArrayValue.prototype, "properties", null);
__decorate([
    (0, bitstream_1.Field)((i) => 0, { string: { encoding: 'utf-8' }, writtenValue: '' }),
    __metadata("design:type", Object)
], EcmaArrayValue.prototype, "endKey", void 0);
__decorate([
    (0, bitstream_1.Field)(8, { writtenValue: TypeMarker.ObjectEnd }),
    __metadata("design:type", Object)
], EcmaArrayValue.prototype, "endMarker", void 0);
EcmaArrayValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.EcmaArray)
], EcmaArrayValue);
exports.EcmaArrayValue = EcmaArrayValue;
...
ObjectEndValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.ObjectEnd)
], ObjectEndValue);
exports.ObjectEndValue = ObjectEndValue;
...
__decorate([
    (0, bitstream_1.Field)(8 * 4),
    __metadata("design:type", Number)
], StrictArrayValue.prototype, "count", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i.count, { array: { type: Value } }),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Object])
], StrictArrayValue.prototype, "values", null);
StrictArrayValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.StrictArray)
], StrictArrayValue);
exports.StrictArrayValue = StrictArrayValue;
...
__decorate([
    (0, bitstream_1.ReservedLow)(8 * 2, { writtenValue: 0x0000 }),
    __metadata("design:type", Number)
...
__decorate([
    (0, bitstream_1.Field)(8 * 4, { writtenValue: (i) => Buffer.from(i.value).length }),
    __metadata("design:type", Number)
], LongStringValue.prototype, "_length", void 0);
__decorate([
    (0, bitstream_1.Field)((i) => i._length, { string: { encoding: 'utf-8' } }),
    __metadata("design:type", String)
], LongStringValue.prototype, "$value", void 0);
LongStringValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.LongString)
], LongStringValue);
exports.LongStringValue = LongStringValue;
...
UnsupportedValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.Unsupported)
], UnsupportedValue);
...
RecordSetValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.RecordSet)
], RecordSetValue);
exports.RecordSetValue = RecordSetValue;
...
MovieClipValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.MovieClip)
], MovieClipValue);
exports.MovieClipValue = MovieClipValue;
...
AvmPlusValue = __decorate([
    (0, bitstream_1.Variant)(i => i.marker === TypeMarker.AvmPlus)
], AvmPlusValue);
exports.AvmPlusValue = AvmPlusValue;
