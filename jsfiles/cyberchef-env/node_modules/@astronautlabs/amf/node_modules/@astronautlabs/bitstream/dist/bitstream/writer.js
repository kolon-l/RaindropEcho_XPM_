...
exports.BitstreamMeasurer = exports.BitstreamWriter = void 0;
/**
...
class BitstreamWriter {
     ...
     */
    writeString(byteCount, value, encoding = 'utf-8') {
        if (encoding === 'utf-8') {
            ...
            Buffer.from(value, encoding).copy(buffer);
     ...
     */
    writeBytes(chunk, offset = 0, length) {
        length !== null && length !== void 0 ? length : (length = chunk.length - offset);
 ...
 */
class BitstreamMeasurer extends BitstreamWriter {
    constructor() {
        super(null, 1);
        this.bitLength = 0;
    }
...
exports.BitstreamMeasurer = BitstreamMeasurer;
