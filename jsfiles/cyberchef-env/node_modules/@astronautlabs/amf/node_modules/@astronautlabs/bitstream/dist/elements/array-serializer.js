    ...
    *read(reader, type, parent, field) {
        ...
        if ((_b = (_a = field === null || field === void 0 ? void 0 : field.options) === null || _a === void 0 ? void 0 : _a.array) === null || _b === void 0 ? void 0 : _b.countFieldLength) {
            if (!reader.isAvailable(field.options.array.countFieldLength))
                yield { remaining: field.options.array.countFieldLength, contextHint: () => (0, utils_1.summarizeField)(field) };
            ...
            count = (0, resolve_length_1.resolveLength)(field.options.array.count, parent, field);
        }
        else if (field === null || field === void 0 ? void 0 : field.length) {
            count = (0, resolve_length_1.resolveLength)(field === null || field === void 0 ? void 0 : field.length, parent, field);
        }
        if (parent) {
            ...
            if ((_l = (_k = field === null || field === void 0 ? void 0 : field.options) === null || _k === void 0 ? void 0 : _k.array) === null || _l === void 0 ? void 0 : _l.hasMore) {
                do {
                    ...
                    if (!reader.isAvailable(elementLength))
                        yield { remaining: elementLength, contextHint: () => (0, utils_1.summarizeField)(field) };
                    readNumber();
                } while (true);
            }
            else {
            ...
            if (field.options.array.hasMore) {
                ...
                do {
                    ...
                    if (!continued)
                        break;
                    let element;
                    let serializer = new structure_serializer_1.StructureSerializer();
    ...
    write(writer, type, parent, field, value) {
        ...
        if (field.options.array.countFieldLength) {
            ...
            try {
                length = (0, resolve_length_1.resolveLength)(field.options.array.count, parent, field);
            }
            catch (e) {
