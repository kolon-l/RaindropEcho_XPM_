...
<head>
    <title>Code coverage report for src/elements/buffer-serializer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/elements</a> buffer-serializer.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                yield { remaining: result.value*8, contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >summarizeField(field) </span>};</span>
            else
                break;
        }
&nbsp;
...
&nbsp;
        ...
        let truncate = field.options<span class="branch-0 cbranch-no" title="branch not covered" >?.b</span>uffer?.truncate ?? true;
        let fill = field.options<span class="branch-0 cbranch-no" title="branch not covered" >?.b</span>uffer?.fill ?? (truncate ? 0 : false);
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!value) {
<span class="cstat-no" title="statement not covered" >            throw new Error(`BufferSerializer: Field ${String(field.name)}: Cannot encode a null buffer`);</span>
        }
&nbsp;
