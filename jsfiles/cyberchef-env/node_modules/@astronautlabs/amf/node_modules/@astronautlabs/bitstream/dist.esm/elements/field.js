...
export function Field(...args) {
    ...
    return (target, fieldName) => {
        ...
        if (field.type === Array) {
            ...
            if (!(((_b = field.options.array) === null || _b === void 0 ? void 0 : _b.type.prototype) instanceof BitstreamElement) && ((_c = field.options.array) === null || _c === void 0 ? void 0 : _c.type) !== Number)
        ...
        if (!options.serializer) {
            ...
            else if (((_h = field.type) === null || _h === void 0 ? void 0 : _h.prototype) instanceof BitstreamElement)
