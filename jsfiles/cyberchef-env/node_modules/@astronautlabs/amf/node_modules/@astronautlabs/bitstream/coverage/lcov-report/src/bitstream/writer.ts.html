...
<head>
    <title>Code coverage report for src/bitstream/writer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/bitstream</a> writer.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Writable } from "../common";
&nbsp;
/**
...
&nbsp;
    ...
    flush() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.bufferedBytes &gt; 0) {
...
&nbsp;
     ...
     */
    writeString(byteCount : number, value : string, encoding : string = <span class="branch-0 cbranch-no" title="branch not covered" >'utf-8')</span> {
        if (encoding === 'utf-8') {
...
<span class="branch-0 cbranch-no" title="branch not covered" >        length </span>??= chunk.length - offset;
&nbsp;
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (length === 64)
...
&nbsp;
    bitLength = 0;
&nbsp;
<span class="fstat-no" title="function not covered" >    writeString(</span>byteCount : number, value : string, encoding : string = <span class="branch-0 cbranch-no" title="branch not covered" >'utf-8')</span> {
<span class="cstat-no" title="statement not covered" >        this.bitLength += byteCount * 8;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    writeBuffer(</span>buffer : Uint8Array) {
<span class="cstat-no" title="statement not covered" >        this.bitLength += buffer.length * 8;</span>
    }
&nbsp;
    write(length : number, value : number) {
