 ...
 */
export function ReservedLow(length, options = {}) {
    return (target, fieldName) => {
        ...
        return Field(length, Object.assign(Object.assign({}, options), { isIgnored: true, writtenValue: (_, field) => {
                if (field.type === Number)
                    return 0;
            } }))(target, fieldName);
    };
}
//# sourceMappingURL=reserved-low.js.map