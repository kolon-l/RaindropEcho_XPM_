...
<head>
    <title>Code coverage report for src/elements/structure-serializer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/elements</a> structure-serializer.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BitstreamElement } from "./element";
...
export class StructureSerializer implements Serializer {
    *read(reader : BitstreamReader, type : typeof BitstreamElement, parent : BitstreamElement, field : FieldDefinition): Generator&lt;IncompleteReadResult, any&gt; {
    ...
    write(writer: BitstreamWriter, type : any, instance: any, field: FieldDefinition, value: BitstreamElement) {
        ...
        value.write(writer, { skip: field.options<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>kip, context: instance<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>ontext });
    }
}
&nbsp;</pre></td></tr></table></pre>
