...
<head>
    <title>Code coverage report for src/elements/element.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/elements</a> element.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">77.82% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>358/460</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">77.44% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>261/337</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>73/92</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>333/425</span>
            </div>
...
<a name='L1273'></a><a href='#L1273'>1273</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BitstreamMeasurer, BitstreamReader, BitstreamWriter } from "../bitstream";
...
<span class="branch-0 cbranch-no" title="branch not covered" >        variants </span>??= elementType['variants'] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
        
        let variantDefns = variants.map((typeOrVariant : any) =&gt; 
            typeof typeOrVariant === 'function' 
                ? (&lt;VariantDefinition&gt;<span class="branch-0 cbranch-no" title="branch not covered" >{ type: typeOrVariant, discriminant: typeOrVariant.variantDiscriminant })</span>
                : typeOrVariant
        );
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (aPriority === 'first') <span class="cstat-no" title="statement not covered" >aPriority = Number.MIN_SAFE_INTEGER;</span>
            <span class="missing-if-branch" title="if path not taken" >I</span>if (aPriority === 'last') <span class="cstat-no" title="statement not covered" >aPriority = Number.MAX_SAFE_INTEGER;</span>
            
            <span class="missing-if-branch" title="if path not taken" >I</span>if (bPriority === 'first') <span class="cstat-no" title="statement not covered" >bPriority = Number.MIN_SAFE_INTEGER;</span>
...
&nbsp;
    ...
    serialize(fromRef? : FieldRef&lt;this&gt;, toRef? : FieldRef&lt;this&gt;, autoPad = false) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.syntax.length === 0)
...
&nbsp;
        if (!toRef) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.getFieldBeingComputed()) {
                let toIndex = <span class="cstat-no" title="statement not covered" >this.syntax.findIndex(<span class="fstat-no" title="function not covered" >f </span>=&gt; <span class="cstat-no" title="statement not covered" >f.name === this.getFieldBeingComputed().name)</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!this.getFieldBeingComputedIntrospectable())</span>
<span class="cstat-no" title="statement not covered" >                    toIndex -= 1;</span>
                
<span class="cstat-no" title="statement not covered" >                if (toIndex &lt; 0)</span>
<span class="cstat-no" title="statement not covered" >                    return new Uint8Array(0);</span>
                
<span class="cstat-no" title="statement not covered" >                toRef = this.syntax[toIndex].name;</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isBeingRead) {
                let readFields = <span class="cstat-no" title="statement not covered" >this.syntax.filter(<span class="fstat-no" title="function not covered" >x </span>=&gt; <span class="cstat-no" title="statement not covered" >this.readFields.includes(x.name))</span>.map(<span class="fstat-no" title="function not covered" >x </span>=&gt; <span class="cstat-no" title="statement not covered" >x.name)</span>;</span>
<span class="cstat-no" title="statement not covered" >                toRef = readFields[readFields.length - 1];</span>
            } else {
...
&nbsp;
                if (field.options.writtenValue) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof field.options.writtenValue === 'function') {
                        writtenValue = field.options.writtenValue(this, field);
                    } else {
<span class="cstat-no" title="statement not covered" >                        writtenValue = field.options.writtenValue;</span>
                    }
                }
&nbsp;
                try {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (globalThis.BITSTREAM_TRACE !== false) {
<span class="cstat-no" title="statement not covered" >                        console.error(`Failed to write field ${field.type.name}#${String(field.name)} using ${field.options.serializer.constructor.name}: ${e.message}`);</span>
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.getFieldBeingComputedIntrospectable())
                    toIndex -= 1;
                
                <span class="missing-if-branch" title="if path not taken" >I</span>if (toIndex &lt; 0)
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (fromIndex &gt; toIndex) {
<span class="cstat-no" title="statement not covered" >            throw new Error(`Cannot measure from field ${fromIndex} (${String(from.name)}) to ${toIndex} (${String(to.name)}): First field comes after last field`);</span>
        }
&nbsp;
&nbsp;
        for (let i = fromIndex, max = toIndex; i &lt;= max; ++i) {
            let field = this.syntax[i];
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isPresent(field, this))
<span class="cstat-no" title="statement not covered" >                continue;</span>
&nbsp;
            try {
                field.options.serializer.write(measurer, this.constructor, this, field, this[field.name]);
            } catch (e) {
<span class="cstat-no" title="statement not covered" >                if (globalThis.BITSTREAM_TRACE === true) {</span>
<span class="cstat-no" title="statement not covered" >                    console.error(`Failed to measure field ${this.constructor.name}#${String(field.name)}:`);</span>
<span class="cstat-no" title="statement not covered" >                    console.error(e);</span>
                }
<span class="cstat-no" title="statement not covered" >                throw new Error(`${this.constructor.name}#${String(field.name)}: Cannot measure field: ${e.message}`);</span>
            }
        }
&nbsp;
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    measureField(</span>ref? : FieldRef&lt;this&gt;) {
<span class="cstat-no" title="statement not covered" >        return this.measure(ref, ref);</span>
    }
&nbsp;
    /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >    static </span>set ownSyntax(value) {
<span class="cstat-no" title="statement not covered" >        this.ownSyntax.length; </span>// causes property to be created
<span class="cstat-no" title="statement not covered" >        this['$ownSyntax'] = value;</span>
    }
&nbsp;
    #parent : BitstreamElement;
&nbsp;
...
&nbsp;
    private <span class="fstat-no" title="function not covered" >leftPad(</span>num : number | string, digits : number = <span class="branch-0 cbranch-no" title="branch not covered" >4)</span> {
        let str = <span class="cstat-no" title="statement not covered" >`${num}`;</span>
<span class="cstat-no" title="statement not covered" >        while (str.length &lt; digits)</span>
...
&nbsp;
    private <span class="fstat-no" title="function not covered" >rightPad(</span>num : number | string, digits : number = <span class="branch-0 cbranch-no" title="branch not covered" >4)</span> {
        let str = <span class="cstat-no" title="statement not covered" >`${num}`;</span>
<span class="cstat-no" title="statement not covered" >        while (str.length &lt; digits)</span>
<span class="cstat-no" title="statement not covered" >            str = `${str} `;</span>
<span class="cstat-no" title="statement not covered" >        return str;</span>
...
&nbsp;
    private <span class="fstat-no" title="function not covered" >zeroPad(</span>num : number | string, digits : number = <span class="branch-0 cbranch-no" title="branch not covered" >4)</span> {
        let str = <span class="cstat-no" title="statement not covered" >`${num}`;</span>
<span class="cstat-no" title="statement not covered" >        while (str.length &lt; digits)</span>
...
&nbsp;
    private isPresent(element : FieldDefinition, instance : this, reader?: BitstreamReader) {
        if (element.options.presentWhen) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!instance.runWithFieldBeingComputed(element, () =&gt; element.options.presentWhen(instance))) {
                return false;
            }
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (element.options.excludedWhen) {
<span class="cstat-no" title="statement not covered" >            if (instance.runWithFieldBeingComputed(element, <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >element.options.excludedWhen(instance))</span>) {</span>
...
&nbsp;
        try {
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (name.startsWith('$')) { // my own fields in group $&lt;group&gt;
                // if (name !== '*' &amp;&amp; element.options.group !== name)
                let group = <span class="cstat-no" title="statement not covered" >name.slice(1);</span>
<span class="cstat-no" title="statement not covered" >                syntax = this.ownSyntax.filter(<span class="fstat-no" title="function not covered" >x </span>=&gt; <span class="cstat-no" title="statement not covered" >x.options.group === group)</span>;</span>
...
&nbsp;
                if (element.options.readAhead) {
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof element.options.readAhead.length === 'number') {
                        length = element.options.readAhead.length;
                    } else <span class="cstat-no" title="statement not covered" >if (typeof element.options.readAhead.length === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                        length = element.options.readAhead.length(instance, element);</span>
                    }
&nbsp;
                    if (bitstream.available &lt; length) {
                        yield {
                            remaining: length - bitstream.available,
                            contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >`[readAhead ${length} bits]`,</span>
                            optional: true
                        }
                    }
                }
...
&nbsp;
                if (element.options.isVariantMarker) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (globalThis.BITSTREAM_TRACE)
<span class="cstat-no" title="statement not covered" >                        console.log(`Variating at marker...`);</span>
                    
                    let g = this.variate(bitstream, options.parent, options.field);
                    while (true) {
                        let result = g.next();
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (result.done === false) {
                            let incompleteResult = <span class="cstat-no" title="statement not covered" >result.value;</span>
<span class="cstat-no" title="statement not covered" >                            yield { </span>
                                remaining: incompleteResult.remaining,
                                contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >this.summarizeElementField(element, incompleteResult.contextHint()),</span>
...
<span class="cstat-no" title="statement not covered" >                        throw new Error(`Variator did not return a value!`);</span>
...
&nbsp;
                let traceTimeout;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (globalThis.BITSTREAM_TRACE === true) {
<span class="cstat-no" title="statement not covered" >                    traceTimeout = setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        console.log(`[!!] ${element.containingType.name}#${String(element.name)}: Stuck reading!`);</span>
                    }, 5000);
                }
&nbsp;
                try {
...
<span class="cstat-no" title="statement not covered" >                            console.log(`Error while tracing read operation for element ${String(element.name)}: ${e.message}`);</span>
<span class="cstat-no" title="statement not covered" >                            console.error(e);</span>
                        }
&nbsp;
<span class="cstat-no" title="statement not covered" >                        clearTimeout(traceTimeout);</span>
                    }
                } catch (thrown) {
                    let e : Error = thrown;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (e.message.startsWith('underrun:')) {
...
&nbsp;
    ...
    protected writeGroup(bitstream : BitstreamWriter, name : string, options? : CommonOptions) {
        ...
        for (let element of syntax) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (name !== '*' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >element.options.group !== name)</span>
<span class="cstat-no" title="statement not covered" >                continue;</span>
            
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options?.skip &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.skip.includes(element.name))</span>
<span class="cstat-no" title="statement not covered" >                continue;</span>
&nbsp;
            // Preconditions 
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isPresent(element, this))
<span class="cstat-no" title="statement not covered" >                continue;</span>
&nbsp;
            let writtenValue = this[element.name];
&nbsp;
            if (element.options.writtenValue) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof element.options.writtenValue === 'function') {
                    writtenValue = element.options.writtenValue(this, element);
                } else {
<span class="cstat-no" title="statement not covered" >                    writtenValue = element.options.writtenValue;</span>
                }
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (globalThis.BITSTREAM_TRACE === true &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!(bitstream instanceof BitstreamMeasurer))</span> {
                let displayedValue = <span class="cstat-no" title="statement not covered" >`${writtenValue}`;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (typeof writtenValue === 'number') {</span>
<span class="cstat-no" title="statement not covered" >                    displayedValue = `0x${writtenValue.toString(16)} [${writtenValue}]`;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                    console.log(</span>
...
<span class="cstat-no" title="statement not covered" >                    console.log(`Error while tracing write operation for element ${String(element.name)}: ${e.message}`);</span>
<span class="cstat-no" title="statement not covered" >                    console.error(e);</span>
                }
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                if (globalThis.BITSTREAM_TRACE !== false) {</span>
<span class="cstat-no" title="statement not covered" >                    console.error(`Failed to write field ${element.type.name}#${String(element.name)} using ${element.options.serializer.constructor.name}: ${e.message}`);</span>
<span class="cstat-no" title="statement not covered" >                    console.error(e);</span>
                }
<span class="cstat-no" title="statement not covered" >                throw new Error(`Failed to write field ${String(element.name)} using ${element.options.serializer.constructor.name}: ${e.message}`);</span>
            }
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                yield { </span>
                    remaining: incompleteResult.remaining, 
                    contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >this.summarizeElementOperation(`readOwn()`, incompleteResult.contextHint()),</span>
                    optional: incompleteResult.optional
                };
            } else {
                return result.value;
...
&nbsp;
    ...
    *variate(reader : BitstreamReader, parent? : BitstreamElement, field? : FieldDefinition): Generator&lt;IncompleteReadResult, this&gt; {
        ...
        if (variantType) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (globalThis.BITSTREAM_TRACE)
<span class="cstat-no" title="statement not covered" >                console.log(`Selected variant ${variantType.name}`);</span>
...
<span class="cstat-no" title="statement not covered" >                    yield { </span>
                        remaining: incompleteResult.remaining, 
                        contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >this.summarizeElementOperation(`variate()`, incompleteResult.contextHint()),</span>
                        optional: incompleteResult.optional
                    };
                } else {
...
&nbsp;
    ...
    static *read&lt;T extends typeof BitstreamElement&gt;(
        this : T, 
        reader : BitstreamReader,
        options : StaticReadOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{}</span>
    ) {
        options.context ??= {};
        let constructorParams = options.params <span class="branch-0 cbranch-no" title="branch not covered" ></span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.initializer) {
<span class="cstat-no" title="statement not covered" >            options.initializer(element);</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.field?.options?.initializer) {
<span class="cstat-no" title="statement not covered" >            options.field.options.initializer(element, options.parent);</span>
        }
&nbsp;
...
&nbsp;
        if (options.elementBeingVariated) {
            ...
            element.syntax.forEach(f =&gt; {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (options.field<span class="branch-1 cbranch-no" title="branch not covered" >?.options<span class="branch-1 cbranch-no" title="branch not covered" >?</span>.skip </span>&amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.field.options.skip.includes(f.name))</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (options.skip &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.skip.includes(f.name))</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
&nbsp;
                if (options.elementBeingVariated.syntax.some(x =&gt; x.name === f.name) &amp;&amp; options.elementBeingVariated.readFields.includes(f.name)) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (!f.options.isIgnored)
...
&nbsp;
            let g = element.readOwn(reader, { skip: options.field<span class="branch-1 cbranch-no" title="branch not covered" >?.options<span class="branch-1 cbranch-no" title="branch not covered" >?</span>.skip </span>});
            while (true) {
                let result = g.next();
                <span class="missing-if-branch" title="if path not taken" >I</span>if (result.done === false) {
<span class="cstat-no" title="statement not covered" >                    if (allowExhaustion)</span>
<span class="cstat-no" title="statement not covered" >                        return &lt;InstanceType&lt;T&gt;&gt; element;</span>
                    let incompleteResult = <span class="cstat-no" title="statement not covered" >result.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    yield { </span>
                        remaining: incompleteResult.remaining, 
                        contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >element.summarizeElementOperation(`${this.name}.readVariant()`, incompleteResult.contextHint()),</span>
                        optional: incompleteResult.optional
                    };
                } else {
            ...
            let g = element.read(reader, { skip: [...(options.skip ?? []), ...(options.field?.options?.skip<span class="branch-0 cbranch-no" title="branch not covered" > ?? [</span>])] });
            while (true) {
                let result = g.next();
                if (result.done === false) {
                    if (allowExhaustion)
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!element.ownSyntax.some(x =&gt; x.options.isVariantMarker)) {
...
<span class="cstat-no" title="statement not covered" >                    yield { </span>
                        remaining: incompleteResult.remaining, 
                        contextHint: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >element.summarizeElementOperation(`tail-variation`, incompleteResult.contextHint()),</span>
                        optional: incompleteResult.optional
                    };
                } else {
                    element = result.value;
        ...
        if (!options<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>lementBeingVariated)
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Jan 28 2024 01:20:38 GMT-0800 (Pacific Standard Time)
            </div>
