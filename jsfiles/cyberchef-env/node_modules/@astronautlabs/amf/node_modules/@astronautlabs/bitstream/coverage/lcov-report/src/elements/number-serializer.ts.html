...
<head>
    <title>Code coverage report for src/elements/number-serializer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/elements</a> number-serializer.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        let format = field.options<span class="branch-0 cbranch-no" title="branch not covered" >?.n</span>umber?.format ?? 'unsigned';
        if (format === 'unsigned')
