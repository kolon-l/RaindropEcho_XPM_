 ...
 */
export declare function ReservedLow<T extends BitstreamElement>(length: LengthDeterminant<T>, options?: Omit<FieldOptions<T, number>, 'writtenValue' | 'isIgnored'>): InferredPropertyDecorator<T>;
