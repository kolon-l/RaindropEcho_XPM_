...
import { VariantDiscriminant } from "./variant-definition";
 ...
 */
export declare function Variant<T extends BitstreamElement>(discriminant: VariantDiscriminant<T>, options?: VariantOptions): (type: Constructor<T> & typeof BitstreamElement & DiscriminatedVariant) => void;
/**
 ...
 */
export declare function DefaultVariant(): (type: Constructor<BitstreamElement> & typeof BitstreamElement & DiscriminatedVariant) => void;
/**
 ...
 */
export declare function VariantMarker<T extends BitstreamElement>(): InferredPropertyDecorator<T>;
